...
class CommentManager extends Manager
{
    ...
    {
        $db = $this->dbConnect();
        $sql = $db->prepare('DELETE FROM `comments` WHERE id = ?');
    ...
    public function addComments($postId, $pseudo, $contenu, $date)
    {
        ...
        $db = $this->dbConnect();
        $sql = $db->prepare('INSERT INTO `comments`(Id_Post, Auteur, Contenue, Date) VALUES (:postId, :pseudo, :contenu, :ladate)');
    ...
    $sql->execute(array($postId, $pseudo, $contenu, $date));
    /*
